...
const rules = [
  ...
  { title: 'Laboratory Guidelines', description: 'Computer labs are to be used exclusively for academic purposes. Mobile phones and unauthorized software are strictly prohibited.' },
